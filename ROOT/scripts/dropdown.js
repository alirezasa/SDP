...
function showhideLayer(obj, e, visible, hidden, menuwidth){
if (ie4||ns6)
...
if (ie4||ns6){
showhideLayer(dropmenuobj.style, e, "visible", "hidden", menuwidth)
dropmenuobj.x=getposOffset(obj, "left")
dropmenuobj.y=getposOffset(obj, "top")
dropmenuobj.style.left=dropmenuobj.x-clearbrowseredge(obj, "rightedge")-43+"px"
...
if (ie4||ns6)
delayhide=setTimeout(function(){hidemenu()},disappeardelay);
}
