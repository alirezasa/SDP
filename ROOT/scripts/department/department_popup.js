var $departmentPopup = {
    fetchMetaData: function(id){
        sdpAjax({
            url: "/api/v3/departments/" + id,//No I18N
            success: function (response) {
                $departmentPopup.resp = response;
            },
        ...
        sdpAjax({
            url: "/api/v3/departments/_metainfo", // No I18N
            success: function(resp) {
                $departmentPopup.metaData = resp.metainfo;
            },
            failedCallBack : function(resp){
                var responseText = resp.responseJSON.response_status;
                    if(responseText.status_code === 4000) {
    ...
    loadDepartmentPopup: function(key) {
        jQuery('#'+key).panelSlider({
            title : translate("sdp.app.asset.details",[translate("sdp.admin.technician.listview.department")]),
            modal:"true",
            resizable: false,
            width: "650px",  // No I18N
    ...
    cancelPopup: function() {
        jQuery('#departmentPopup').dialog("close"); // No I18N
    },
    openPopup: function(id){
        var departmentView = [{
            ...
            "fields" : { //No I18N
                "department_udf_fields" : {} //No I18N
            }
        }];
        $departmentPopup.fetchMetaData(id);
        var formData = departmentView;
        var template = $departmentPopup.constructLayoutObject(formData, $departmentPopup.metaData.fields, false);
        ...
        var configJSON = {
            name: "department",// No I18N
            entity: "mdh",// No I18N
            entitypath: "departments",// No I18N
            entitydata: $departmentPopup.resp.department,
            template: template,
            metadata: jQuery.extend(true, {}, $departmentPopup.metaData),
            mode: "view",    // No I18N
            container: "departmentPopup",// No I18N
            formid: "department_popup",// No I18N
            canEdit: false,
            afterRenderCallback: function () {
                jQuery("#departmentPopup").dialog("option", "position", { my: "center", at: "center", of: window }); //No I18N
            }
        };
        var fc = new FC(configJSON);
        $departmentPopup.loadDepartmentPopup("departmentPopup"); //No I18N
    },
